...
local Config = {
    ...
    DataModuleURL = "https://raw.githubusercontent.com/your-repo/AutoFarm/main/BloxFruitsData.lua",
    FunctionsModuleURL = "https://raw.githubusercontent.com/your-repo/AutoFarm/main/AutoFarmFunctions.lua", 
    GUIModuleURL = "https://raw.githubusercontent.com/your-repo/AutoFarm/main/AutoFarmPro.lua",
...
local function createLoadingScreen()
    ...
    return {
        ...
        destroy = function(self)
            TweenService:Create(self.gui, TweenInfo.new(0.5), {BackgroundTransparency = 1}):Play()
            wait(0.5)
            self.gui:Destroy()
        end
    }
