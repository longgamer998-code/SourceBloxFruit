...
-- TAB CLICK HANDLERS
--============================================
local function updateTabButtons(activeTab)
    local tabs = {tabFarm, tabQuest, tabSettings}
...
tabFarm.MouseButton1Click:Connect(function()
    ...
    updateTabButtons(tabFarm)
end)

tabQuest.MouseButton1Click:Connect(function()
    farmContent.Visible = false
    questContent.Visible = true
    settingsContent.Visible = false
    updateTabButtons(tabQuest)
end)
